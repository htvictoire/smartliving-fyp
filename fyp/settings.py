...
STATICFILES_DIRS =[
    os.path.join(BASE_DIR, 'static')           # for django server
]

#STATIC_ROOT = os.path.join(BASE_DIR, 'static') # for real server
...
ADMIN_EMAIL = "test@bnjcongo.com"
SUPPORT_EMAIL = "victoirehabamungut@gmail.com"
